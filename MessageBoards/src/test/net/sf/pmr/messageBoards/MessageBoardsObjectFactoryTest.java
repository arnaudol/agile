 ...
 */
public class MessageBoardsObjectFactoryTest extends TestCase {
    ...
    public void testGetObject() {
        ...
        try {
            MessageBoardsObjectFactory.getMessage();
        } catch (Exception e) {
            fail("should not throw an exeception : " + e.getLocalizedMessage());
        }
    }
}