 ...
 */
public final class MessageMapperImpl extends
    ...
    public Object findById(final int id) {
        ...
        return getHibernateTemplate().get(MessageImpl.class, new Integer(id));
     ...
     * (non-Javadoc)
     * 
     * @see com.pm.core.data.ValueObjectMapper#updateForObject(java.lang.Object,
     *      com.pm.core.domain.ValueObject)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.keops.data.MapperForAgregateMember#deleteForObject(java.lang.Object,
     *      java.lang.Object)
     */
