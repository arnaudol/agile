// MockCreator v2.9.0 build 3065; HashCode:-236703160; net.sf.pmr.core.domain.basicProject.BasicProjectRepository
package net.sf.pmr.core.domain.basicProject;

import de.abstrakt.mock.MockCore;

public class MockBasicProjectRepository implements net.sf.pmr.core.domain.basicProject.BasicProjectRepository, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",null);
        return this;
    }

    public net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock expectAnyCtor(Throwable th)
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",th);
        return this;
    }
...
public void expectAddOrUpdate(net.sf.pmr.core.domain.basicProject.BasicProject p0_BasicProject)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_BasicProject);

    MockCore.addExpectedMethodCall( getClassObjectMethodSignature("addOrUpdate(BasicProject)"),params );
}
public void expectAddOrUpdate(net.sf.pmr.core.domain.basicProject.BasicProject p0_BasicProject,java.lang.Throwable toThrow)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_BasicProject);

    MockCore.addExpectedMethodCall( getClassObjectMethodSignature("addOrUpdate(BasicProject)"),params,toThrow );
}
...
{
  MockCore.setDummy(getClassObjectMethodSignature("addOrUpdate(BasicProject)"),null,null);
}
public void setAddOrUpdateDummy(java.lang.Throwable toThrow)
{
    MockCore.setDummy(getClassObjectMethodSignature("addOrUpdate(BasicProject)"),null,toThrow);
}
public void setAddOrUpdateDummy(net.sf.pmr.core.domain.basicProject.BasicProject p0_BasicProject,java.lang.Throwable toThrow)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_BasicProject);

    MockCore.setDummy( getClassObjectMethodSignature("addOrUpdate(BasicProject)"),params,toThrow);
}
...
params.add(p0_BasicProject);
    ...
    MockCore.setDummy(getClassObjectMethodSignature("addOrUpdate(BasicProject)"),params,valueToThrow);
}


public void expectFindByPersistanceId(int p0_int, net.sf.pmr.core.domain.basicProject.BasicProject valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
...
public void acceptFindByPersistanceId(Object p0_int, net.sf.pmr.core.domain.basicProject.BasicProject valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_int);
...
public void setFindByPersistanceIdDummy(net.sf.pmr.core.domain.basicProject.BasicProject toReturn)
{
...
public void setFindByPersistanceIdDummy(int p0_int,net.sf.pmr.core.domain.basicProject.BasicProject toReturn)
{
    java.util.List params = new java.util.ArrayList();
        params.add(new Integer(p0_int));
...
public void acceptFindByPersistanceIdDummy(Object p0_int, net.sf.pmr.core.domain.basicProject.BasicProject valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_int);
...
params.add(p0_int);
    ...
    private String getClassObjectMethodSignature(String method){ return "net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository"+"#"+__id()+"#"+method; }
    private String id;
    public String __id(){ return id; }
    public static final String MOCK_CREATOR_BASE_TYPE = "net.sf.pmr.core.domain.basicProject.BasicProjectRepository";
}
    public MockBasicProjectRepository()
    {
        java.util.List params = new java.util.ArrayList();
        Object idex = MockCore.generateId("net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",params);
    ...
    public static net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",params);
        return new net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock(id);
    }

    public static net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",null);
        return new net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock(id);
    }

    public static net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock expectAnyCtor(Throwable th)
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository",th);
        return new net.sf.pmr.core.domain.basicProject.MockBasicProjectRepository.PreMock(id);
    }
...
public void acceptCountAllDummy(java.lang.Throwable valueToThrow)
{
    ...
    public void addOrUpdate(net.sf.pmr.core.domain.basicProject.BasicProject p0_BasicProject)
    {
        id = MockCore.enteredMethodBody(id);
        Object returnValue = null;
        java.util.List params = new java.util.ArrayList();
        ...
        returnValue = MockCore.getReturnValue( getClassObjectMethodSignature("addOrUpdate(BasicProject)"),params,MockCore.OPT_UNEXPECTED_VOID_OKAY);
    if( returnValue instanceof RuntimeException )
    {
        throw (RuntimeException)returnValue;
    }
...
params.add(p0_BasicProject);
    ...
    public net.sf.pmr.core.domain.basicProject.BasicProject findByPersistanceId(int p0_int)
    {
        id = MockCore.enteredMethodBody(id);
        Object returnValue = null;
        java.util.List params = new java.util.ArrayList();
