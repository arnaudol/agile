...
<TABLE width="100%" border="0" cellspacing="0" cellpadding="0"> 
	<TR> 
		<TD>
			  <display:table defaultsort="1" pagesize="10000" name="storyList" class="default" style="cellpadding:0;cellspacing=0;border:0;width:100%;align:left" requestURI="iteration.do?action=storiesToAdd" decorator="net.sf.pmr.struts.agilePlanning.release.story.table.Decorator">
