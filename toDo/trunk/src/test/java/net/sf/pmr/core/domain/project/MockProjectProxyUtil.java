...
public class MockProjectProxyUtil implements net.sf.pmr.core.domain.project.ProjectProxyUtil, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.domain.project.MockBasicProjectProxyUtil",null);
        return this;
    }

    public net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock expectAnyCtor(Throwable th)
    {
...
params.add(p0_BasicProject);
    ...
    public static net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.domain.project.MockBasicProjectProxyUtil",params);
        return new net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock(id);
    }

    public static net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.domain.project.MockBasicProjectProxyUtil",null);
        return new net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock(id);
    }

    public static net.sf.pmr.core.domain.project.MockProjectProxyUtil.PreMock expectAnyCtor(Throwable th)
    {
