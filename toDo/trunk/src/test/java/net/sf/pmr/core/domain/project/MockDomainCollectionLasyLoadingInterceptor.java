...
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor",null);
        return this;
    }

    public net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock expectAnyCtor(Throwable th)
    {
...
params.add(p0_MethodInvocation);
    ...
    public static net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor",params);
        return new net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock(id);
    }

    public static net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock expectAnyCtor()
    {
    ...
    public static net.sf.pmr.core.domain.project.MockDomainCollectionLasyLoadingInterceptor.PreMock expectAnyCtor(Throwable th)
    {
