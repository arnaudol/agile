...
public class MockProject implements net.sf.pmr.core.domain.project.Project, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.domain.project.MockProject.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.domain.project.MockBasicProject",null);
        return this;
    }

    public net.sf.pmr.core.domain.project.MockProject.PreMock expectAnyCtor(Throwable th)
    {
...
params.add(p0_long);
    ...
    public static net.sf.pmr.core.domain.project.MockProject.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.domain.project.MockBasicProject",params);
        return new net.sf.pmr.core.domain.project.MockProject.PreMock(id);
    }

    public static net.sf.pmr.core.domain.project.MockProject.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.domain.project.MockBasicProject",null);
        return new net.sf.pmr.core.domain.project.MockProject.PreMock(id);
    }

    public static net.sf.pmr.core.domain.project.MockProject.PreMock expectAnyCtor(Throwable th)
    {
