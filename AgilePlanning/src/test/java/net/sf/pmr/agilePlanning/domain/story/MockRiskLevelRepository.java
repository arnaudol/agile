// MockCreator v2.9.0 build 3065; HashCode:-964425669; net.sf.pmr.agilePlanning.domain.story.RiskLevelRepository
package net.sf.pmr.agilePlanning.domain.story;

import de.abstrakt.mock.MockCore;

public class MockRiskLevelRepository implements net.sf.pmr.agilePlanning.domain.story.RiskLevelRepository, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",null);
        return this;
    }

    public net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock expectAnyCtor(Throwable th)
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",th);
        return this;
    }

public void expectFindById(int p0_int, net.sf.pmr.agilePlanning.domain.story.RiskLevel valueToReturn)
{
...
public void acceptFindById(Object p0_int, net.sf.pmr.agilePlanning.domain.story.RiskLevel valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_int);
...
public void setFindByIdDummy(net.sf.pmr.agilePlanning.domain.story.RiskLevel toReturn)
{
...
public void setFindByIdDummy(int p0_int,net.sf.pmr.agilePlanning.domain.story.RiskLevel toReturn)
{
    java.util.List params = new java.util.ArrayList();
        params.add(new Integer(p0_int));
...
public void acceptFindByIdDummy(Object p0_int, net.sf.pmr.agilePlanning.domain.story.RiskLevel valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_int);
...
public void acceptFindAllDummy(java.lang.Throwable valueToThrow)
{
    ...
    private String getClassObjectMethodSignature(String method){ return "net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository"+"#"+__id()+"#"+method; }
    private String id;
    public String __id(){ return id; }
    public static final String MOCK_CREATOR_BASE_TYPE = "net.sf.pmr.agilePlanning.domain.story.RiskLevelRepository";
}
    public MockRiskLevelRepository()
    {
        java.util.List params = new java.util.ArrayList();
        Object idex = MockCore.generateId("net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",params);
    ...
    public static net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",params);
        return new net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock(id);
    }

    public static net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",null);
        return new net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock(id);
    }

    public static net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock expectAnyCtor(Throwable th)
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository",th);
        return new net.sf.pmr.agilePlanning.domain.story.MockRiskLevelRepository.PreMock(id);
    }

    public net.sf.pmr.agilePlanning.domain.story.RiskLevel findById(int p0_int)
    {
