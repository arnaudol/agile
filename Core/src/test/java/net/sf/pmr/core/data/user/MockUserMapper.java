// MockCreator v2.9.0 build 3065; HashCode:1781409385; net.sf.pmr.core.data.user.UserMapper
package net.sf.pmr.core.data.user;

import de.abstrakt.mock.MockCore;

public class MockUserMapper implements net.sf.pmr.core.data.user.UserMapper, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.data.user.MockUserMapper.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.data.user.MockUserMapper",null);
        return this;
    }

    public net.sf.pmr.core.data.user.MockUserMapper.PreMock expectAnyCtor(Throwable th)
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.data.user.MockUserMapper",th);
        return this;
    }

public void expectFindByLogin(java.lang.String p0_String, net.sf.pmr.core.domain.user.User valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_String);

    MockCore.addExpectedMethodCall( getClassObjectMethodSignature("findByLogin(String)"),params, valueToReturn );
}
public void expectFindByLogin(java.lang.String p0_String,java.lang.Throwable toThrow)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_String);

    MockCore.addExpectedMethodCall( getClassObjectMethodSignature("findByLogin(String)"),params,toThrow );
}
public void acceptFindByLogin(Object p0_String, net.sf.pmr.core.domain.user.User valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_String);
...
public void acceptFindByLogin(Object p0_String,java.lang.Throwable toThrow)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_String);
...
public void setFindByLoginDummy(net.sf.pmr.core.domain.user.User toReturn)
{
  MockCore.setDummy(getClassObjectMethodSignature("findByLogin(String)"),null,toReturn);
}
public void setFindByLoginDummy(java.lang.Throwable toThrow)
{
    MockCore.setDummy(getClassObjectMethodSignature("findByLogin(String)"),null,toThrow);
}
public void setFindByLoginDummy(java.lang.String p0_String,java.lang.Throwable toThrow)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_String);

    MockCore.setDummy( getClassObjectMethodSignature("findByLogin(String)"),params,toThrow);
}
public void setFindByLoginDummy(java.lang.String p0_String,net.sf.pmr.core.domain.user.User toReturn)
{
    java.util.List params = new java.util.ArrayList();
        params.add(p0_String);

    MockCore.setDummy( getClassObjectMethodSignature("findByLogin(String)"),params,toReturn);
}
public void acceptFindByLoginDummy(Object p0_String, net.sf.pmr.core.domain.user.User valueToReturn)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_String);

    MockCore.setDummy( getClassObjectMethodSignature("findByLogin(String)"),params, valueToReturn );
}
public void acceptFindByLoginDummy(Object p0_String, java.lang.Throwable valueToThrow)
{
    java.util.List params = new java.util.ArrayList();
params.add(p0_String);

    MockCore.setDummy(getClassObjectMethodSignature("findByLogin(String)"),params,valueToThrow);
}
...
params.add(p0_Object);
    ...
    private String getClassObjectMethodSignature(String method){ return "net.sf.pmr.core.data.user.MockUserMapper"+"#"+__id()+"#"+method; }
    private String id;
    public String __id(){ return id; }
    public static final String MOCK_CREATOR_BASE_TYPE = "net.sf.pmr.core.data.user.UserMapper";
}
    public MockUserMapper()
    {
        java.util.List params = new java.util.ArrayList();
        Object idex = MockCore.generateId("net.sf.pmr.core.data.user.MockUserMapper",params);
    ...
    public static net.sf.pmr.core.data.user.MockUserMapper.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.data.user.MockUserMapper",params);
        return new net.sf.pmr.core.data.user.MockUserMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.user.MockUserMapper.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.data.user.MockUserMapper",null);
        return new net.sf.pmr.core.data.user.MockUserMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.user.MockUserMapper.PreMock expectAnyCtor(Throwable th)
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.data.user.MockUserMapper",th);
        return new net.sf.pmr.core.data.user.MockUserMapper.PreMock(id);
    }

    public net.sf.pmr.core.domain.user.User findByLogin(java.lang.String p0_String)
    {
        ...
        returnValue = MockCore.getReturnValue( getClassObjectMethodSignature("findByLogin(String)"),params,MockCore.OPT_DEFAULT);
