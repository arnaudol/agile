// MockCreator v2.9.0 build 3065; HashCode:-27916575; net.sf.pmr.core.data.user.company.CompanyMapper
package net.sf.pmr.core.data.user.company;

import de.abstrakt.mock.MockCore;

public class MockCompanyMapper implements net.sf.pmr.core.data.user.company.CompanyMapper, de.abstrakt.mock.MockBase 
{
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.data.user.company.MockCompanyMapper",null);
        return this;
    }

    public net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock expectAnyCtor(Throwable th)
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.data.user.company.MockCompanyMapper",th);
        return this;
    }
...
params.add(p0_int);
    ...
    private String getClassObjectMethodSignature(String method){ return "net.sf.pmr.core.data.user.company.MockCompanyMapper"+"#"+__id()+"#"+method; }
    private String id;
    public String __id(){ return id; }
    public static final String MOCK_CREATOR_BASE_TYPE = "net.sf.pmr.core.data.user.company.CompanyMapper";
}
    public MockCompanyMapper()
    {
        java.util.List params = new java.util.ArrayList();
        Object idex = MockCore.generateId("net.sf.pmr.core.data.user.company.MockCompanyMapper",params);
    ...
    public static net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.data.user.company.MockCompanyMapper",params);
        return new net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.data.user.company.MockCompanyMapper",null);
        return new net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock expectAnyCtor(Throwable th)
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.data.user.company.MockCompanyMapper",th);
        return new net.sf.pmr.core.data.user.company.MockCompanyMapper.PreMock(id);
    }
