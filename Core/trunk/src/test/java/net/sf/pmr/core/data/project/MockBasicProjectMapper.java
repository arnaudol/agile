...
public static class PreMock implements de.abstrakt.mock.MockBase 
{
    ...
    public net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock expectAnyCtor()
    {
        id = MockCore.addExpectedAnyCtor(__id(),"net.sf.pmr.core.data.project.MockBasicProjectMapper",null);
        return this;
    }

    public net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock expectAnyCtor(Throwable th)
    {
...
params.add(p0_int);
    ...
    public static net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock expectCtor()
    {
        java.util.List params = new java.util.ArrayList();
        String id = MockCore.addExpectedCtor(null,"net.sf.pmr.core.data.project.MockBasicProjectMapper",params);
        return new net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock expectAnyCtor()
    {
        String id = MockCore.addExpectedAnyCtor(null,"net.sf.pmr.core.data.project.MockBasicProjectMapper",null);
        return new net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock(id);
    }

    public static net.sf.pmr.core.data.project.MockBasicProjectMapper.PreMock expectAnyCtor(Throwable th)
    {
